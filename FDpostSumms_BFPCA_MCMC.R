MCMC <- function(Y,           # Matrix of functional observations Y_i(t_j) (matrix, n x T)
  ...
  ##              described in "Central Posterior Envelopes for Bayesian 
  ...
  ##              Materials Appendix A of the manuscript. Posterior samples of size M 
  ##              using the BFPCA model are returned from this function and include 
  ##              the set of model parameters and model components described in Section 2.1
  ##              as well as the post-processing posterior alignment of the eigenfunctions 
  ...
  list.of.packages <- c("fda", "MASS", "Matrix")
